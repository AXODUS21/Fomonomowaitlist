...
import { XCircle, CheckCircle2, Heart, ShieldAlert, Sparkles } from "lucide-react";

export default function Comparison() {
  return (
    <section id="philosophy" className="py-24 sm:py-32 px-4 sm:px-8 max-w-6xl mx-auto w-full">
      <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
        ...
        <p className="mt-5 text-base sm:text-lg text-[#718096] leading-relaxed">
          Mainstream media apps are designed by attention economists whose sole goal is keeping you hooked. FOMO NOMO is built to be closed.
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 items-stretch">
        {/* The Bad Old Way Card */}
        <div className="rounded-[32px] p-8 sm:p-12 bg-white/70 border border-red-200/60 shadow-sm relative overflow-hidden flex flex-col justify-between">
          <div className="absolute top-0 right-0 w-36 h-36 bg-red-100/40 rounded-full blur-2xl pointer-events-none" />

          <div>
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-3.5">
                <div className="w-12 h-12 rounded-2xl bg-red-50 border border-red-200 flex items-center justify-center text-xl shadow-2xs">
                  😵‍💫
                </div>
                <div>
                  ...
                  <p className="text-xs text-[#718096]">Social feeds, algorithmic news apps</p>
                </div>
              </div>
            ...
            <ul className="space-y-5 text-sm text-[#718096] mb-10">
              ...
              <li className="flex items-start gap-3.5">
                <XCircle className="w-5 h-5 text-red-500 shrink-0 mt-0.5" />
                <span>
                  <strong className="text-[#2D3748]">Recurring subscription traps:</strong> $10 to $20 charged every single month just to read repetitive news.
                </span>
              </li>
            </ul>
          </div>

          <div className="p-5 rounded-2xl bg-red-50/70 border border-red-100 flex items-center gap-3.5 text-xs text-red-900 font-medium">
        ...
        <div className="glass-card rounded-[32px] p-8 sm:p-12 border border-white/90 shadow-xl relative overflow-hidden flex flex-col justify-between bg-gradient-to-br from-white/95 via-white/85 to-[#AECFD0]/25">
          ...
          <div>
            <div className="flex items-center justify-between mb-8">
              ...
              <span className="px-3.5 py-1 rounded-full text-xs font-bold bg-[#A3D6BC]/40 text-[#2D3748] border border-[#A3D6BC]/50">
                5 Mins / Day
              </span>
            </div>
            ...
            <ul className="space-y-5 text-sm text-[#718096] mb-10">
              ...
              <li className="flex items-start gap-3.5">
                <CheckCircle2 className="w-5 h-5 text-[#10B981] shrink-0 mt-0.5" />
                <span>
                  <strong className="text-[#2D3748]">The &ldquo;Done For Today&rdquo; guarantee:</strong> Once your daily digest is finished, the app locks the feed so you can live offline.
                </span>
              </li>
              <li className="flex items-start gap-3.5">
                <CheckCircle2 className="w-5 h-5 text-[#10B981] shrink-0 mt-0.5" />
              ...
              <li className="flex items-start gap-3.5">
                <CheckCircle2 className="w-5 h-5 text-[#10B981] shrink-0 mt-0.5" />
                <span>
                  <strong className="text-[#2D3748]">One-time payment, own forever:</strong> No monthly subscription fees. Pay once, use it for life.
                </span>
              </li>
            </ul>
          </div>

          <div className="p-5 rounded-2xl bg-[#AECFD0]/25 border border-[#AECFD0]/50 flex items-center gap-3.5 text-xs text-[#2D3748] font-medium">
